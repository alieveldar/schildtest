<?php
	...
	$show_page_title = neighborhood_get_post_meta($post->ID, 'sf_page_title', true);
	$page_title_one = neighborhood_get_post_meta($post->ID, 'sf_page_title_one', true);
	$page_title_bg = neighborhood_get_post_meta($post->ID, 'sf_page_title_bg', true);
	$no_breadcrumbs = neighborhood_get_post_meta($post->ID, 'sf_no_breadcrumbs', true);
	...
	$sidebar_config = neighborhood_get_post_meta($post->ID, 'sf_sidebar_config', true);
	$left_sidebar = strtolower(neighborhood_get_post_meta($post->ID, 'sf_left_sidebar', true));
	$right_sidebar = strtolower(neighborhood_get_post_meta($post->ID, 'sf_right_sidebar', true));
	...
	neighborhood_set_sidebar_global($sidebar_config);
