...
if($minimum - $subtotal >0 ){
    ...
    // WC()->cart->set_total((string) $difference + WC()->cart->total);
    $difference_flag = 1; 
...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table cellspacing="0">
		...
		<tr class="cart-subtotal">
			<th><?php _e( 'Cart Subtotal', 'neighborhood' ); ?></th>
        ...
        <?php if($difference_flag){
        echo "<tr><th>Differenzbetrag</th><td>+$difference CHF</td></tr>";
        }
        ?>
		<tr class="order-total">

			<th><?php _e( 'Order Total', 'neighborhood' ); ?></th>
